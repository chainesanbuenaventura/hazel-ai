      ...
      {!isCollapsed && (
        <>
          ...
          >
            ...
            {/* CHAT TAB - scrollable messages, input fixed at bottom */}
            <TabsContent
              value="ai-chat"
              className="flex-1 mt-0 px-3 flex flex-col data-[state=inactive]:hidden"
            >
              <div className="flex flex-col h-full min-h-0">
                {/* Scrollable suggestions + messages */}
                ...
                {/* Input bar (fixed within tab, does NOT move up) */}
            ...
            >
              {selectedCandidateDetails ? (
                <div className="flex flex-col h-full overflow-hidden">
                  ...
                  {/* Profile tab content (same as your version) */}
                      ...
                      <ScrollArea className="flex-1 px-3 py-4">
                        <Card className="border-2 border-primary/20 shadow-md">
                          ...
                          <CardContent className="pt-4">
                            {/* Your existing resume preview content */}
                          </CardContent>
                        </Card>
                      </ScrollArea>
                    )}
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <textarea
                              ...
                              defaultValue={selectedCandidateDetails.notes || ""}
                            />
                          </CardContent>
                        </Card>
                      </ScrollArea>
                  ...
                  <Card className="mx-0 max-w-full">
                    ...
                    <CardContent>
                      <Select
                        ...
                        onValueChange={(value) =>
                          setSelectedCampaignView(value || null)
                        }
                      >
                        <SelectTrigger>
